               ...
               // echo $this->Form->hidden('old_image', ['value' => $user['image']]);
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <!--<div class="col-md-6">
                            <div class="form-group">
                                <label for="form-name" class="col-sm-4 control-label">User Type</label>
                                <div class="col-sm-8 tabular-border">
                                    <?php
                                    //$UserType = Configure::read('SiteSetting.UserType');
                                    //echo $this->Form->input('user_type', ['label' => false, 'options' => $UserType, 'class' => 'form-control', 'placeholder' => 'User Type']);
                                    ?>
                                </div>
                            </div> 
                        </div>-->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-sm-4 control-label">Is Discovery</label>
                                <div class="col-sm-8">
                                    <label class="radio-inline icheck">
                                        <?php
                                        echo $this->Form->checkbox('is_discovery', array('value'=>'1'), array());
                                        //echo $this->Form->radio('is_discovery', Configure::read('SiteSetting.OptionYesNo'), array());
                                        ?> 
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="row">                                                
                        <div class="col-md-6">
                            <?php
                            $ImagesPath = Configure::read('Site.ProfileImage');
                            $imageName = 'no-user.png';
                            if (isset($user['user_detail']['profile_image'])) {
                                if ($user['user_detail']['profile_image'] != '') {
                                    $profile_image_Path = $ImagesPath . $user['user_detail']['profile_image'];
                                    if (file_exists($profile_image_Path)) {
                                        $imageName = $user['user_detail']['profile_image'];
                                    }
                                }
                            }
                            ?>
                            <div class="form-group">
                                <label for="form-image" class="col-sm-4 control-label">Image</label>
                                <div class="col-sm-8 tabular-border">                                          
...
<?php
    $this->Html->script(['adminSetting', "https://maps.googleapis.com/maps/api/js?sensor=false&libraries=places"], ['block' => true]);

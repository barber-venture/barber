            ...
            <?php if ($this->request->session()->read('Auth.User.id') == "") { ?>
				...
				<div class="formContainer">
				  <h2>Join Now it’s Free</h2>
                        ...
                        <?php echo $this->Form->input('name', ['autocomplete' => 'off', 'label' => false, 'class' => 'form-control', 'placeholder' => 'Name', 'maxlength' => 30]); ?>
                    </div>
                    <div class="form-group">
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="videoplayer animated3 fadeInLeft">
          ...
          <div class="videoplayBtn"> <a href="#" class="videoplay" data-toggle="modal" data-target="#videoPopup"></a></div>
...
<section id="secureSection" class="clearfix" data-role="datanav">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="securebox animated3 fadeInDown">
          <div class="secureboxItem">
            <div class="secureboxTextTop"><span>Two-Step</span><span>Member</span>Verification</div>
            <img src="img/secure-seal.png" alt="">
            <div class="secureboxTextBottom">
              <div class="leftText"> <span>100% Privacy</span>Guaranteed</div>
              <div class="rightText"> <span>SSL Secured</span>Website</div>
...
<!-- start About section -->
<section id="aboutSection" class="clearfix">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="aboutBox animated3 fadeInDown">
          <h2>About us</h2>
			<p>
Sweeedy is Ghana's First Premium Online Dating Website (Social Discovery Website) which helps Single Ghanaian's (Home and Abroad) and other Nationals to find Cherished Relationships that will most likely lead to Marriages.
</p>
			<p>The platform is free to sign-up and very simple to navigate discreetly in searching for partners who share same interests. Equipped with the latest security intelligence, user’s privacy is protected at all times.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
		<div class="modal-header">
      	...
      	<div class="modal-body">
			<video id="popup_video" width="100%" height="100%" controls>
				<source src="<?php echo SITE_FULL_URL;?>/video/VID-20160928-WA0000.mp4" type="video/mp4">
			</video>
      </div>
    </div>
  </div>

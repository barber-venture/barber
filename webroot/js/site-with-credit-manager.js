    ...
    var validateCreditAppForm = function () {
        $(postApplicationForm).validate({
            ...
            submitHandler:function (form){                
                ...
                if ($('input[name="is_mortgage"]').is(':checked') && $('input[name="is_property_taxes"]').is(':checked') && $('input[name="is_involuntary"]').is(':checked') && $('input[name="fo_is_attest"]').is(':checked')) {
                    if ($('#property-ownership').val() == 'Joint') {
                        if ($('input[name="so_is_attest"]').is(':checked')) {
                            submitFlag = true;
                        } else {
                            submitFlag = false;
                        }
                ...
                if(submitFlag){
                    ...
                    bootbox.confirm({
                        message: '<ol><li>You&#39;ve had more than one late mortgage payment in the past 12 months.</li><li>You&#39;ve had more than one delinquent property tax payment in the past 3 years.</li><li>You&#39;ve had an active bankruptcy case in the past 24 months.</li></ol>',
                        title:'In this application at least ONE of the following is true.',
                        buttons: {
                            'cancel': {

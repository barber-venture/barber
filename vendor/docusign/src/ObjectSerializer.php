...
class ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders=null)
    {
        if (null === $data) {
            ...
            if(preg_match('/.*filename=([^ ]+)/', $httpHeaders['Content-Disposition'], $matches)) {
                
                $uploads_dir = 'F:\xampp\htdocs\docusign\docusign\Docs\\';
                
                //$match = explode('"',$matches[1]);
                
                $myfile = fopen($uploads_dir.'file.pdf', "w");
            ...
            //$str = $httpHeaders['Content-Disposition'];
            //preg_match_all("/[^\'\']+$/", $str, $output);
            //$filename = explode(';',$output[0][0]);
